...
public class LettuceRedisStorageProvider extends AbstractStorageProvider implements NoSqlStorageProvider {
    ...
    public LettuceRedisStorageProvider(RedisClient redisClient, String keyPrefix, RateLimiter changeListenerNotificationRateLimit) {
        this(redisClient.connect(), keyPrefix, changeListenerNotificationRateLimit);
    }

    public LettuceRedisStorageProvider(StatefulRedisConnection<String, String> connection, RateLimiter changeListenerNotificationRateLimit) {
        this(connection, JOBRUNR_DEFAULT_PREFIX, changeListenerNotificationRateLimit);
    }

    public LettuceRedisStorageProvider(StatefulRedisConnection<String, String> connection, String keyPrefix, RateLimiter changeListenerNotificationRateLimit) {
        super(changeListenerNotificationRateLimit);
        this.keyPrefix = keyPrefix;
        this.connection = connection;

        new LettuceRedisDBCreator(this, connection, keyPrefix).runMigrations();
    }
